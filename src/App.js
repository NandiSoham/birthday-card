    ...
    <div className="relative w-full overflow-hidden">
          ...
          >
            ...
            <div className="relative z-10 p-8 md:p-12">
              ...
              <div className="space-y-4 text-white text-opacity-90 leading-relaxed">
                <p className="font-light text-lg">Tomorrow marks the celebration of another incredible year in your extraordinary journey, and I simply couldn't let this moment pass without honoring all that you are.</p>
                
                <p>Throughout my life, you've been my compass, my confidant, and my constant source of inspiration. Your wisdom has guided me, your laughter has lifted me, and your unwavering support has been my foundation.</p>
                
                <div className="py-4 pl-4 border-l-2 border-pink-400 italic">
                  <p>For every moment you've listened without judgment,<br/>
                  For every time you've celebrated my victories as if they were your own,<br/>
                  For every lesson you've taught through both words and actions...</p>
                </div>
                
                <p>I am <span className="font-bold text-transparent bg-clip-text bg-gradient-to-r from-pink-300 to-purple-300">forever grateful</span> that you're in my life. Your kindness, wisdom, and incredible spirit illuminate the world in ways that words cannot fully capture.</p>
                
                <p>May this coming year bring you all the joy, love, and adventure that you so richly deserve.</p>
              </div>
      ...
      <style jsx>{`
        ...
        @keyframes spark {
          ...
          100% { transform-origin: center; transform: rotate(var(--angle)) translateY(-120px); opacity: 0; }
        }
        ...
        .animate-flicker-alt {
          animation: flicker-alt 2s ease-in-out infinite;
        }
        .animate-fadeIn {
